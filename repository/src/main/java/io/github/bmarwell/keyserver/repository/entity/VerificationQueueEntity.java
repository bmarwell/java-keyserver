...
/// ## ID assignment
///
/// The ID is always generated by {@link io.github.bmarwell.keyserver.repository.JpaVerificationQueueRepository}
/// using the node-aware {@code TSID.Factory} CDI bean **before** the entity is
/// constructed.  This keeps ID creation in a single place and ensures the node ID
/// is always applied — there is no `@PrePersist` fallback.
///
    ...
    private void validateId() {
        if (this.id == null) {
            throw new IllegalStateException(
                    "VerificationQueueEntity.id must be set before persisting — use JpaVerificationQueueRepository");
        }
    }
